	...
	return (
		<div className="flex h-96 w-full items-center justify-center">
			<Popover
				...
				content={
					<div className="w-64 text-gray-500 text-sm dark:text-gray-400">
						<div className="border-gray-200 border-b bg-gray-100 px-3 py-2 dark:border-gray-600 dark:bg-gray-700">
							<h3
								id="popover-title"
