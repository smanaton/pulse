...
RatingCount.args = {
	children: (
		<>
			<RatingStar />
			<p className="ml-2 font-bold text-gray-900 text-sm dark:text-white">
				4.95
			</p>
			<span className="mx-1.5 size-1 rounded-full bg-gray-500 dark:bg-gray-400" />
			<a
				href="#"
				className="font-medium text-gray-900 text-sm underline hover:no-underline dark:text-white"
			>
				73 reviews
			</a>
		</>
...
export const Advanced = (): JSX.Element => (
	<div className="flex flex-col gap-4">
		...
		<p className="pb-3 font-medium text-gray-500 text-sm dark:text-gray-400">
