...
const DefaultTemplate: StoryFn<ClipboardProps> = () => (
	<div className="grid w-full max-w-[23rem] grid-cols-8 gap-2">
		...
		<input
			id="npm-install"
			type="text"
			className="col-span-6 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-gray-500 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 dark:placeholder:text-gray-400"
	...
	<div className="grid w-full max-w-80">
		<div className="relative">
			...
			<input
				id="npm-install"
				type="text"
				className="col-span-6 block w-full rounded-lg border border-gray-300 bg-gray-50 px-2.5 py-4 text-gray-500 text-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 dark:placeholder:text-gray-400"
				value="npm install flowbite-react"
				disabled
				readOnly
			/>
