		...
		<>
			...
			<ModalBody>
				<div className="space-y-6">
					<p className="text-base text-gray-500 leading-relaxed dark:text-gray-400">
			...
			<ModalBody>
				<div className="space-y-6 px-6 pb-4 sm:pb-6 lg:px-8 xl:pb-8">
					...
					<div className="flex justify-between">
						...
						<a
							href="/modal"
							className="text-cyan-700 text-sm hover:underline dark:text-cyan-500"
						>
							Lost Password?
						</a>
					</div>
					...
					<div className="font-medium text-gray-500 text-sm dark:text-gray-300">
						Not registered?&nbsp;
						<a
							href="/modal"
