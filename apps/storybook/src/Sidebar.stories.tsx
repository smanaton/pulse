	...
	children: (
		<>
			...
			<SidebarCTA>
				...
				<p className="mb-3 text-cyan-900 text-sm dark:text-cyan-400">
					Preview the new Flowbite dashboard navigation! You can turn the new
					navigation off for a limited time in your profile.
				</p>
				<a
					href="#"
					className="text-cyan-900 text-sm underline hover:text-cyan-800 dark:text-cyan-400 dark:hover:text-cyan-300"
				>
