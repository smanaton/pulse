import {
	...
	a as q,
	Y as U,
} from "./DocsRenderer-PQXLIZUC-Be_zaew9.js";
import { r as p, R as v } from "./iframe-ByD-PdrA.js";
import "./preload-helper-Dp1pzeXC.js";
import "./react-18-EEPVhOKt.js";
			...
			(u.rgb.keyword = (e) => {
				...
				(u.hsl.hcg = (e) => {
					let n = e[1] / 100,
						...
						o = 0;
					return (
						a < 1 && (o = (t - 0.5 * a) / (1 - a)), [e[0], a * 100, o * 100]
					);
				}),
				(u.hsv.hcg = (e) => {
					let n = e[1] / 100,
	...
	return (C =
		...
		((r) => {
			for (var l = 1; l < arguments.length; l++) {
				var s = arguments[l];
				for (var h in s) Object.hasOwn(s, h) && (r[h] = s[h]);
			}
			return r;
...
var O = (r, l, s) => (
			...
			a = p.useMemo(() => {
				...
				return [
					(y) => {
						var m = y.nativeEvent,
							k = u.current;
						if (k && (W(m), !((x, R) => R && !S(x))(m, t.current) && k)) {
							if (S(m)) {
								t.current = !0;
	...
	K = (r) => (
		...
		r.length < 6
			...
			: {
					...
					a:
						r.length === 8
							? w(Number.parseInt(r.substring(6, 8), 16) / 255, 2)
							: 1,
				}
	),
		...
		return v.createElement(
			...
			v.createElement(
				G,
				{
					...
					onKey: (u) => {
						s({
							s: O(l.s + 100 * u.left, 0, 100),
							v: O(l.v - 100 * u.top, 0, 100),
						});
					},
					"aria-label": "Color",
					"aria-valuetext":
	...
	$e = (r, l) => r.toLowerCase() === l.toLowerCase() || ne(K(r), K(l));
function le(r, l, s) {
	var h = L(s),
...
var Oe = typeof window < "u" ? p.useLayoutEffect : p.useEffect,
	...
	Ne = (r) => {
		var l = r.className,
			...
			d = r.onChange,
			e = D(r, ["className", "colorModel", "color", "onChange"]),
			n = p.useRef(null);
		oe(n);
		var t = le(s, u, d),
			a = t[0],
	...
	je = (r) => v.createElement(Ne, C({}, r, { colorModel: Re })),
	ze = (r) => {
		var l = r.className,
			s = r.hsva,
			h = r.onChange,
	...
	A = ({ value: r, style: l, ...s }) => {
		...
		return v.createElement(De, { ...s, style: { ...l, backgroundImage: h } });
	},
	...
	er = (r) => {
		let l = r.replace("#", ""),
			...
			u = r;
		/[^#a-f0-9]/i.test(r) ? (u = l) : V.test(r) && (u = `#${l}`);
		let d = !0;
		if (u.startsWith("#")) d = V.test(u);
		else
			try {
	...
	rr = (r, l, s) => {
		...
		if (!h) return V.test(l.hex) ? l.hex : z.hex;
	...
	hr = ar;
export { ar as ColorControl, hr as default };
