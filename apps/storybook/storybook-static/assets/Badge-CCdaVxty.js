...
const u = y({
		root: {
			...
			color: {
				...
				light:
					"bg-gray-200 text-gray-800 hover:bg-gray-300 dark:bg-gray-400 dark:text-gray-900 dark:hover:bg-gray-500",
				green:
					"bg-green-100 text-green-800 hover:bg-green-200 dark:bg-green-200 dark:text-green-900 dark:hover:bg-green-300",
	...
	w = x.forwardRef((r, i) => {
		...
		const a = c(),
			e = p(
				[u, (b = a.theme) == null ? void 0 : b.badge, r.theme],
				[n(a.clearTheme, "badge"), r.clearTheme],
				[n(a.applyTheme, "badge"), r.applyTheme],
			),
			{
				children: o,
				color: k = "info",
				...
				className: s,
				...h
			} = v(r, (l = a.props) == null ? void 0 : l.badge);
		return t.jsxs("span", {
			ref: i,
			className: m(
				e.root.base,
			...
			children: [
				g &&
					t.jsx(g, {
						"aria-hidden": !0,
						className: e.icon.size[d],
						"data-testid": "flowbite-badge-icon",
					}),
				o && t.jsx("span", { children: o }),
			],
		});
	});
w.displayName = "Badge";
export { w as B, u as b };
