...
import { r as d, j as u } from "./iframe-ByD-PdrA.js";
const m = k({
	...
	x = d.forwardRef((r, g) => {
		...
		const e = l(),
			n = y(
				[m, (a = e.theme) == null ? void 0 : a.checkbox, r.theme],
				[t(e.clearTheme, "checkbox"), r.clearTheme],
				[t(e.applyTheme, "checkbox"), r.applyTheme],
			),
			{
				className: i,
				color: c = "default",
				indeterminate: s,
				...f
			} = p(r, (o = e.props) == null ? void 0 : o.checkbox);
		return u.jsx("input", {
			ref: g,
			type: "checkbox",
			className: b(n.base, n.color[c], s && n.indeterminate, i),
			...f,
		});
	});
