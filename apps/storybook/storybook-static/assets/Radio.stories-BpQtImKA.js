...
import { j as f, r as p } from "./iframe-ByD-PdrA.js";
...
const R = m({
	...
	o = p.forwardRef((r, u) => {
		...
		const a = x(),
			n = b(
				[R, (t = a.theme) == null ? void 0 : t.radio, r.theme],
				[i(a.clearTheme, "radio"), r.clearTheme],
				[i(a.applyTheme, "radio"), r.applyTheme],
			),
			{
				color: l = "default",
				className: k,
				...y
			} = h(r, (s = a.props) == null ? void 0 : s.radio);
		return f.jsx("input", {
			ref: u,
			type: "radio",
			className: w(n.base, n.color[l], k),
			...y,
		});
	});
o.displayName = "Radio";
const _ = { title: "Components/Radio", component: o },
	T = (r) => f.jsx(o, { ...r }),
	e = T.bind({});
e.storyName = "Radio";
e.args = {};
...
e.parameters = {
	...
	docs: {
		...
		source: {
			...
			...((c = (d = e.parameters) == null ? void 0 : d.docs) == null
				? void 0
				: c.source),
		},
	},
};
const E = ["DefaultRadio"];
export { e as DefaultRadio, E as __namedExportsOrder, _ as default };
