...
import { Callout } from "astro:components";

# Development Workflow Guide

> Solo Developer Quick Reference — proper Git workflow with branch protection

<Callout type="warning">The `master` branch is PROTECTED. You cannot push directly to it. All changes must go through pull requests.</Callout>
