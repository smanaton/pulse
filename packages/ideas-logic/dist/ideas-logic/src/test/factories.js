...
// ============================================================================
let idCounter = 1;
export const mockId = (tableName) => {
    return `${tableName}_${idCounter++}`;
};
...
export const IdeaFactory = {
    ...
    invalidCreateInput(overrides = {}) {
        return {
            workspaceId: "", // Invalid empty ID
            title: "",
            contentMD: "",
            createdBy: "", // Invalid empty ID
            ...overrides,
        };
    },
    // Valid update inputs
    validUpdateInput(overrides = {}) {
        return {
            title: "Updated Title",
            status: "active",
            ...overrides,
